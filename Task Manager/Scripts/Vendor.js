function Add() {
   ...
   // var u_email = document.getElementById('user_email').value.trim();
    ...
    var notapprove = document.getElementById('notapprove');
    var active = document.getElementById('active').value.trim();
    var notactive = document.getElementById('inactive').value.trim();
    ...
    else if (u_nic == "") { alert("Please You NIC"); }
    else if (u_designation == "") { alert("Please Your Designation"); }
    else if (u_mobno == "") { alert("Please Insert Valid Number"); }
    else if (validateEmail(u_email) == false) { alert("Please valid Emai"); }
    else if ((approve == false) || (notapprove == false)) { alert("Please select Any Evaluation Phase"); }
    else if ((active == false) || (inactive == false)) { alert("Please select Any Vendor Status"); }
